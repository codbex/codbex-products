...
const dao = require("codbex-products/gen/dao/ProductsSettings/ProductCategory");
const http = require("codbex-products/gen/api/utils/http");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("ProductCategory not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-products/gen/api/ProductCategory.js/" + entity.Id);
