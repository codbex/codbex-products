...
const dao = require("codbex-products/gen/dao/Products1/Product");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-products/gen/api/Product.js/" + entity.Id);
