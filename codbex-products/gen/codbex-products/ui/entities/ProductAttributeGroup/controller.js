angular.module('page', ['blimpKit', 'platformView', 'EntityService'])
	...
	.controller('PageController', ($scope, EntityService, Extensions, ButtonStates) => {
			...
			EntityService.count(filter).then((resp) => {
				...
				request.then((response) => {
					...
					Dialogs.showAlert({
						...
						message: `Unable to list/filter ProductAttributeGroup: '${error.message}'`,
				...
				Dialogs.showAlert({
					title: 'ProductAttributeGroup',
					message: `Unable to count ProductAttributeGroup: '${error.message}'`,
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
		...
		$scope.deleteEntity = (entity) => {
			let id = entity.Id;
			Dialogs.showDialog({
				title: 'Delete ProductAttributeGroup?',
				message: `Are you sure you want to delete ProductAttributeGroup? This action cannot be undone.`,
				buttons: [{
					id: 'delete-btn-yes',
				...
				if (buttonId === 'delete-btn-yes') {
					EntityService.delete(id).then((response) => {
						...
						Dialogs.showAlert({
							title: 'ProductAttributeGroup',
							message: `Unable to delete ProductAttributeGroup: '${message}'`,
							type: AlertTypes.Error
						});
						console.error('EntityService:', error);
					});
