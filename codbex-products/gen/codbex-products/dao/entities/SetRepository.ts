...
export class SetRepository {
    ...
    private async triggerEvent(data: SetEntityEvent | SetUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-products-entities-Set", ["trigger"]);
        ...
        producer.topic("codbex-products-entities-Set").send(JSON.stringify(data));
    }
}
