...
interface ProductAttributeGroupEntityEvent {
...
interface ProductAttributeGroupUpdateEntityEvent extends ProductAttributeGroupEntityEvent {
...
export class ProductAttributeGroupRepository {
    ...
    public findById(id: number): ProductAttributeGroupEntity | undefined {
