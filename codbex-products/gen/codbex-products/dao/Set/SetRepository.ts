...
export class SetRepository {
    ...
    private async triggerEvent(data: SetEntityEvent | SetUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-products-Set-Set", ["trigger"]);
        ...
        producer.topic("codbex-products-Set-Set").send(JSON.stringify(data));
    }
}
