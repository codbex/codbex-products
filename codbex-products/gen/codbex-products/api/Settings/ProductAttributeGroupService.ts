...
class ProductAttributeGroupService {
    ...
    private readonly repository = new ProductAttributeGroupRepository();

    @Get("/")
    public getAll(_: any, ctx: any) {
        try {
            const options: ProductAttributeGroupEntityOptions = {
    ...
    public getById(_: any, ctx: any) {
        try {
            ...
            if (entity) {
                ...
                HttpUtils.sendResponseNotFound("ProductAttributeGroup not found");
            }
        } catch (error: any) {
            this.handleError(error);
        }
