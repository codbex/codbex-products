...
import { SetRepository, SetEntityOptions } from "../../dao/entities/SetRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-products-entities-Set", ["validate"]);
...
class SetService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-products/gen/codbex-products/api/entities/SetService.ts/" + entity.Id);
    ...
    private validateEntity(entity: any): void {
        ...
        if (entity.MeasureType === null || entity.MeasureType === undefined) {
            throw new ValidationError(`The 'MeasureType' property is required, provide a valid value`);
        }
        if (entity.MeasureType?.length > 40) {
            throw new ValidationError(`The 'MeasureType' exceeds the maximum length of [40] characters`);
        }
