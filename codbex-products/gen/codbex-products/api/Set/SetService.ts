...
import { SetRepository, SetEntityOptions } from "../../dao/Set/SetRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-products-Set-Set", ["validate"]);
...
class SetService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-products/gen/codbex-products/api/Set/SetService.ts/" + entity.Id);
