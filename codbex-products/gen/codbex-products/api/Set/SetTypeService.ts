...
import { SetTypeRepository, SetTypeEntityOptions } from "../../dao/Set/SetTypeRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-products-Set-SetType", ["validate"]);
...
class SetTypeService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-products/gen/codbex-products/api/Set/SetTypeService.ts/" + entity.Id);
