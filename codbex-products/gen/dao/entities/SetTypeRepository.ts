...
export class SetTypeRepository {
    ...
    private async triggerEvent(data: SetTypeEntityEvent | SetTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-products-entities-SetType", ["trigger"]);
        ...
        producer.topic("codbex-products-entities-SetType").send(JSON.stringify(data));
    }
}
